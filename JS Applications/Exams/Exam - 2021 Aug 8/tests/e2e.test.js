...
describe('E2E tests', function () {
    ...
    describe('My Books Page [ 10 Points ]', async () => {
        ...
        it('the logged-in user should be able to view his/her own books - detailed information [ 2.5 Points ]', async () => {
            ...
            const secondImg = await page.getAttribute(`.my-books-list > li:has-text("${mock[1].title}") img`, 'src');
            ...
            expect(secondImg).to.contains(mock[1].imageUrl);
...
/**
 * Mock server response at specified path and methods
